...
#### Bioinformatiics
1. Rstudio + RMarkdwon
1. Version control: git and github integration
1. Basic shell programming
1. Basic cluster computing
1. +/- Snakemake

#### Lab techniques
1. Cell culture
1. Electronic lab notebook documentation
...
1. Fully proficient in (and able to teach me!) mammalian fibroblast cell culture protocols.
    - Obtain training from Raegan before she leaves in July.
    - Additional training as necessary from Laura, other lab mates.
1. Help develop project design for larger FeLV cell culture + genome sequencing project.
